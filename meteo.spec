...
%define DEPENS_RPM desktop-file-utils, rpmdevtools, git, gcc, wget, meson, ninja, vala, vala-devel, gettext, libgee-devel, gtk4-devel, libadwaita-devel, libsoup-devel, json-glib-devel, libwebkitgtk-6_0-4, AppStream
